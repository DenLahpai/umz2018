                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        Request: &nbsp;
                                        <input type="text" name="Request" id="Request" placeholder="Request">
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                ...
                                foreach ($rows_guide_requests as $row_guide_requests) {
                                    ...
                                    echo "<td><a href=\"edit_guide_request.php?guide_requestsId=$row_guide_requests->Id\"><button type=\"button\">Edit</button></a></td>";
                                    echo "</tr>";
                                }
                                ?>
                            </tbody>
